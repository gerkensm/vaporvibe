...
const MODEL_BENCHMARKS: Record<string, ModelBenchmarks> = {
  ...
  "groq:llama-3.3-70b-versatile": {
    artificialAnalysisIntelligenceIndex: 28,
    terminalBenchHard: 0.03,
    telecomBench: 0.27,
    aaLcr: 0.15,
    humanitysLastExam: 0.04,
    mmluPro: 0.71,
    gpqaDiamond: 0.5,
    liveCodeBench: 0.29,
    sciCode: 0.26,
    ...
    math500: 0.77,
    humanEval: 0.86,
    blendedCostUsdPer1MTokens: 0.6,
    throughput: {
      medianTokensPerSecond: 107,
      p5TokensPerSecond: 15,
      p25TokensPerSecond: 47,
      p75TokensPerSecond: 187,
      p95TokensPerSecond: 429,
    },
    latency: {
      firstAnswerChunkSeconds: 0.42,
      firstAnswerTokenSeconds: 0.42,
      p5FirstChunkSeconds: 0.21,
      p25FirstChunkSeconds: 0.3,
      p75FirstChunkSeconds: 0.59,
      p95FirstChunkSeconds: 0.93,
      totalResponseSeconds: 5.09,
      reasoningTimeSeconds: 0,
    },
  },
  "groq:meta-llama/llama-4-maverick-17b-128e-instruct": {
    artificialAnalysisIntelligenceIndex: 36,
    terminalBenchHard: 0.06,
    telecomBench: 0.18,
    aaLcr: 0.46,
    humanitysLastExam: 0.05,
    mmluPro: 0.81,
    gpqaDiamond: 0.67,
    liveCodeBench: 0.4,
    sciCode: 0.33,
    ...
    math500: 0.89,
    humanEval: 0.88,
    blendedCostUsdPer1MTokens: 0.4,
    throughput: {
      medianTokensPerSecond: 125,
      p5TokensPerSecond: 39,
      p25TokensPerSecond: 74,
      p75TokensPerSecond: 357,
      p95TokensPerSecond: 1936,
    },
    latency: {
      firstAnswerChunkSeconds: 0.36,
      firstAnswerTokenSeconds: 0.36,
      p5FirstChunkSeconds: 0.17,
      p25FirstChunkSeconds: 0.28,
      p75FirstChunkSeconds: 0.51,
      p95FirstChunkSeconds: 1.34,
      totalResponseSeconds: 4.35,
      reasoningTimeSeconds: 0,
    },
  },
  "groq:meta-llama/llama-4-scout-17b-16e-instruct": {
    artificialAnalysisIntelligenceIndex: 28,
    terminalBenchHard: 0.01,
    telecomBench: 0.16,
    aaLcr: 0.26,
    humanitysLastExam: 0.04,
    mmluPro: 0.75,
    ...
    math500: 0.84,
    humanEval: 0.83,
    blendedCostUsdPer1MTokens: 0.24,
    throughput: {
      medianTokensPerSecond: 118,
      p5TokensPerSecond: 44,
      p25TokensPerSecond: 69,
      p75TokensPerSecond: 232,
      p95TokensPerSecond: 2532,
    },
    latency: {
      firstAnswerChunkSeconds: 0.44,
      firstAnswerTokenSeconds: 0.44,
      p5FirstChunkSeconds: 0.15,
      p25FirstChunkSeconds: 0.3,
      p75FirstChunkSeconds: 0.73,
      p95FirstChunkSeconds: 1.23,
      totalResponseSeconds: 4.68,
      reasoningTimeSeconds: 0,
    },
  },
  "groq:moonshotai/kimi-k2-instruct-0905": {
    artificialAnalysisIntelligenceIndex: 50,
    terminalBenchHard: 0.23,
    telecomBench: 0.73,
    aaLcr: 0.52,
    humanitysLastExam: 0.06,
    mmluPro: 0.82,
    gpqaDiamond: 0.77,
    liveCodeBench: 0.61,
    sciCode: 0.31,
    ifBench: 0.42,
    aime2025: 0.57,
    blendedCostUsdPer1MTokens: 1.34,
    throughput: {
      medianTokensPerSecond: 55,
      p5TokensPerSecond: 19,
      p25TokensPerSecond: 34,
      p75TokensPerSecond: 98,
      p95TokensPerSecond: 315,
    },
    latency: {
      firstAnswerChunkSeconds: 0.47,
      firstAnswerTokenSeconds: 0.47,
      p5FirstChunkSeconds: 0.23,
      p25FirstChunkSeconds: 0.32,
      p75FirstChunkSeconds: 0.67,
      p95FirstChunkSeconds: 1.48,
      totalResponseSeconds: 9.49,
      reasoningTimeSeconds: 0,
    },
  },
  "groq:openai/gpt-oss-120b": {
    artificialAnalysisIntelligenceIndex: 58,
    terminalBenchHard: 0.22,
    telecomBench: 0.66,
    aaLcr: 0.51,
    humanitysLastExam: 0.19,
    mmluPro: 0.81,
    gpqaDiamond: 0.78,
    liveCodeBench: 0.65,
    sciCode: 0.36,
    ifBench: 0.69,
    aime2025: 0.93,
    blendedCostUsdPer1MTokens: 0.26,
    throughput: {
      medianTokensPerSecond: 327,
      p5TokensPerSecond: 113,
      p25TokensPerSecond: 203,
      p75TokensPerSecond: 472,
      p95TokensPerSecond: 2298,
    },
    latency: {
      firstAnswerChunkSeconds: 0.45,
      firstAnswerTokenSeconds: 6.57,
      p5FirstChunkSeconds: 0.18,
      p25FirstChunkSeconds: 0.28,
      p75FirstChunkSeconds: 0.65,
      p95FirstChunkSeconds: 35.11,
      totalResponseSeconds: 8.1,
      reasoningTimeSeconds: 6.12,
    },
  },
  "groq:openai/gpt-oss-20b": {
    artificialAnalysisIntelligenceIndex: 43,
    terminalBenchHard: 0.06,
    telecomBench: 0.5,
    aaLcr: 0.19,
    humanitysLastExam: 0.09,
    mmluPro: 0.74,
    gpqaDiamond: 0.62,
    liveCodeBench: 0.57,
    sciCode: 0.35,
    ifBench: 0.61,
    aime2025: 0.62,
    blendedCostUsdPer1MTokens: 0.09,
    throughput: {
      medianTokensPerSecond: 233,
      p5TokensPerSecond: 86,
      p25TokensPerSecond: 140,
      p75TokensPerSecond: 263,
      p95TokensPerSecond: 985,
    },
    latency: {
      firstAnswerChunkSeconds: 0.39,
      firstAnswerTokenSeconds: 8.98,
      p5FirstChunkSeconds: 0.15,
      p25FirstChunkSeconds: 0.22,
      p75FirstChunkSeconds: 0.87,
      p95FirstChunkSeconds: 30.36,
      totalResponseSeconds: 11.13,
      reasoningTimeSeconds: 8.59,
    },
  },
  "openai:gpt-5": {
