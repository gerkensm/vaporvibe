...
const MODEL_BENCHMARKS: Record<string, ModelBenchmarks> = {
  ...
  "openai:o3": {
    ...
    latency: {
      firstAnswerChunkSeconds: 42.278,
      firstAnswerTokenSeconds: 42.278,
      p5FirstChunkSeconds: 18.476,
      p25FirstChunkSeconds: 15.585,
      p75FirstChunkSeconds: 45.627,
      p95FirstChunkSeconds: 14.2,
      totalResponseSeconds: 20.059,
      reasoningTimeSeconds: 0,
    },
  },
  ...
  "gemini:gemini-2.5-flash": {
    ...
    latency: {
      firstAnswerChunkSeconds: 45.666,
      firstAnswerTokenSeconds: 45.666,
      p5FirstChunkSeconds: 24.654,
      p25FirstChunkSeconds: 19.207,
      p75FirstChunkSeconds: 25.143,
      p95FirstChunkSeconds: 45.701,
      totalResponseSeconds: 32.051,
      reasoningTimeSeconds: 0,
    },
  },
  "gemini:gemini-2.5-flash-lite": {
    ...
    latency: {
      firstAnswerChunkSeconds: 29.677,
      firstAnswerTokenSeconds: 29.677,
      p5FirstChunkSeconds: 43.525,
      p25FirstChunkSeconds: 23.071,
      p75FirstChunkSeconds: 20.576,
      p95FirstChunkSeconds: 35.916,
      totalResponseSeconds: 18.749,
      reasoningTimeSeconds: 0,
    },
  },
  "anthropic:claude-sonnet-4-5-20250929": {
    ...
    latency: {
      ...
      p5FirstChunkSeconds: 23.743,
      p25FirstChunkSeconds: 32.509,
      p75FirstChunkSeconds: 42.036,
      p95FirstChunkSeconds: 29.252,
  ...
  "anthropic:claude-sonnet-4-20250514": {
    ...
    latency: {
      firstAnswerChunkSeconds: 26.299,
      firstAnswerTokenSeconds: 36.13,
      p5FirstChunkSeconds: 17.899,
      p25FirstChunkSeconds: 23.012,
      p75FirstChunkSeconds: 29.587,
      p95FirstChunkSeconds: 45.84,
  ...
  "anthropic:claude-opus-4-1-20250805": {
    ...
    latency: {
      firstAnswerChunkSeconds: 24.504,
      firstAnswerTokenSeconds: 47.11,
      p5FirstChunkSeconds: 45.81,
      p25FirstChunkSeconds: 19.756,
      p75FirstChunkSeconds: 34.731,
      p95FirstChunkSeconds: 42.795,
  ...
  "grok:grok-4-fast-reasoning": {
    ...
    latency: {
      firstAnswerChunkSeconds: 23.59,
      firstAnswerTokenSeconds: 23.59,
      p5FirstChunkSeconds: 21.976,
      p25FirstChunkSeconds: 42.856,
  ...
  "grok:grok-code-fast-1": {
    ...
    latency: {
      firstAnswerChunkSeconds: 12.601,
      firstAnswerTokenSeconds: 12.601,
      p5FirstChunkSeconds: 45.872,
      p25FirstChunkSeconds: 31.168,
      p75FirstChunkSeconds: 44.044,
      p95FirstChunkSeconds: 19.694,
      totalResponseSeconds: 43.709,
      reasoningTimeSeconds: 0,
    },
  },
};
