(() => {
  ...
  '    <button type="button" class="vaporvibe-instructions-ab-button" data-vaporvibe-ab-button>',
  '      <span aria-hidden="true">✨</span>',
  '      <span>Try A/B Variants…</span>',
  '    </button>',
  ...
  function ensureAbModal(): AbModalElements | null {
    ...
    if (!container) {
      ...
      container.innerHTML = [
        ...
        '    <div class="vaporvibe-ab-title" id="vaporvibe-ab-title">',
        '      <span aria-hidden="true">✨</span>',
        '      <span>Create A/B Iteration</span>',
        '    </div>',
        ...
        '      <button type="submit" class="admin-primary" data-vaporvibe-ab-submit disabled>',
        '        <span aria-hidden="true">⚡</span>',
        '        <span>Generate A/B Comparison</span>',
        '      </button>',
        '    </div>',
        '  </form>',
        '</div>',
