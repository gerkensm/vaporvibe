...
export class AdminController {
    ...
    async handleHistoryImport(context, reqLogger) {
        ...
        try {
            ...
            const historyEntries = parsed.history.map((entry) => ({
                ...entry,
