...
export function renderAttachmentUploader(options) {
    const { inputName, inputId, label = "Add attachments", hint = "Drop files, paste with Ctrl+V, or browse to upload.", browseLabel = "Browse files", accept = "image/*,application/pdf", multiple = true, emptyStatus = "No files selected yet.", } = options;
