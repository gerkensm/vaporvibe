...
import { DEFAULT_MODEL_BY_PROVIDER, PROVIDER_LABELS, PROVIDER_REASONING_CAPABILITIES, } from "../../constants/providers.js";
...
export function renderModelSelectorDataScript() {
    ...
    const providerCapabilitiesJson = JSON.stringify(PROVIDER_REASONING_CAPABILITIES).replace(/</g, "\\u003c");
    return `<script>
