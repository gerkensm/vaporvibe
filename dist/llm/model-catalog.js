...
export const PROVIDER_METADATA = {
    ...
    gemini: {
        ...
        maxOutputTokens: {
            ...
            max: 65_536,
            min: 1,
            description: "Gemini 2.5 responses cap at 65,536 output tokens, while earlier experimental builds follow their documented ceilings.",
        },
        reasoningTokens: {
            supported: true,
            min: 0,
            ...
            default: -1,
            allowDisable: true,
            description: "Leave blank or -1 for Gemini’s dynamic thinking. Set 0 to disable where supported or raise the cap for deliberate runs.",
            helper: "Flash and Flash Lite support disabling reasoning with 0. Pro always thinks but lets you set a ceiling or use auto (-1).",
        },
        models: [
            {
                ...
                reasoningTokens: {
                    ...
                    max: 24_576,
                    default: -1,
                    description: "Use -1 for Gemini’s dynamic thinking, 0 to disable, or raise the ceiling up to 24,576 tokens.",
                    allowDisable: true,
                },
            ...
            },
            {
                ...
                reasoningTokens: {
                    ...
                    max: 24_576,
                    default: 4_096,
                    description: "Flash Lite defaults to no deliberate thinking. Enable reasoning to budget between 512 and 24,576 tokens.",
                    allowDisable: true,
                },
            ...
            },
            {
                ...
                reasoningTokens: {
                    ...
                    max: 32_768,
                    default: -1,
                    description: "Gemini Pro always engages deliberate thinking. Set -1 for dynamic budgeting or cap it up to 32,768 tokens.",
                    allowDisable: false,
                },
    ...
    anthropic: {
        ...
        maxOutputTokens: {
            ...
            max: 64_000,
            min: 1,
            description: "Claude responses comfortably scale to 64K tokens across the Sonnet and Opus tiers.",
        },
        reasoningTokens: {
            supported: true,
            min: 0,
    ...
    groq: {
        ...
        description: "Groq provides the world's fastest inference for large language models, serving a variety of open-source models.",
        placeholder: "gsk_...",
        ...
        models: [
            {
                ...
                description: "A highly capable model from the Llama 3.3 family, suitable for a wide range of complex reasoning and generation tasks.",
                recommendedFor: "Demanding applications requiring deep understanding and nuanced text generation.",
                release: "2024",
                contextWindow: 131_072,
                contextWindowUnit: "tokens",
                featured: true,
            ...
            },
            {
                ...
                description: "Llama 4 Maverick is designed for handling extremely long contexts, making it ideal for document analysis and synthesis.",
                recommendedFor: "Processing and reasoning over large documents, codebases, or extensive conversation histories.",
                release: "2024",
                contextWindow: 131_072,
                contextWindowUnit: "tokens",
                featured: true,
                maxOutputTokens: {
                    default: 8_192,
                    max: 8_192,
                    description: "Groq lists an 8,192 token completion budget for this preview build.",
                },
                cost: usdCost({ input: 0.2, output: 0.6 }),
                benchmarks: benchmarkFor("groq:meta-llama/llama-4-maverick-17b-128e-instruct"),
            },
            {
                value: "meta-llama/llama-4-scout-17b-16e-instruct",
                label: "Llama 4 Scout",
                tagline: "Preview build tuned for analytical guardrails.",
                description: "Llama 4 Scout delivers Groq’s preview alignment work with a generous 131K context for structured evaluations.",
                recommendedFor: "Large-scale research, financial analysis, and legal document review.",
                release: "2024",
                contextWindow: 131_072,
                contextWindowUnit: "tokens",
                featured: true,
                maxOutputTokens: {
                    default: 8_192,
                    max: 8_192,
                    description: "Groq quotes an 8,192 token completion limit for this Scout preview model.",
                },
                cost: usdCost({ input: 0.11, output: 0.34 }),
                benchmarks: benchmarkFor("groq:meta-llama/llama-4-scout-17b-16e-instruct"),
            },
            {
                value: "moonshotai/kimi-k2-instruct-0905",
                label: "Kimi K2 (0905)",
                tagline: "A strong model focused on reasoning and tool use.",
                description: "Kimi K2 shows strong performance in agentic tasks, long-context reasoning, and instruction following.",
                recommendedFor: "Workflows that require tool integration and complex reasoning chains.",
                release: "Sep 2025",
                ...
                maxOutputTokens: {
                    default: 16_384,
                    max: 16_384,
                    description: "Groq documents a 16,384 token completion ceiling for Kimi K2.",
                },
            ...
            },
            {
                ...
                description: "A large, high-performing open-source model with excellent reasoning and instruction-following capabilities.",
                recommendedFor: "Advanced tasks requiring strong intelligence and coding skills.",
                release: "2024",
                contextWindow: 131_072,
                contextWindowUnit: "tokens",
                featured: true,
            ...
            },
            {
                ...
                description: "A smaller but still powerful open-source model that balances performance with efficiency.",
                recommendedFor: "General purpose tasks, prototyping, and balanced workloads.",
                release: "2024",
                contextWindow: 131_072,
                contextWindowUnit: "tokens",
                featured: true,
