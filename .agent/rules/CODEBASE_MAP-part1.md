...
> Last updated: 2025-11-24T22:37:57.470Z  
...
graph TD
  ...
  utils["utils/<br/>9 modules"]:::utilNode
...
graph LR
  ...
  ___cli_args_js["args"] --> config_runtime_config_ts
...
- From `../types.js`: `AppConfig`, `ModelProvider`, `ProviderSettings`, `ReasoningMode`, `RuntimeConfig`
...
- From `@google/genai`: `GoogleGenAI`, `GenerateContentConfig`, `ThinkingLevel`
